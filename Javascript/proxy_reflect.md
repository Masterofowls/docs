...
- [objects.md](./objects.md) — property model
- [prototypes.md](./prototypes.md) — prototype ops
- [symbol.md](./symbol.md) — well-known symbols
- [freeze_seal.md](./freeze_seal.md) — hardening without Proxy
- [oop.md](./oop.md) — classes vs interception
