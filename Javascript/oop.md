...
- [new.md](./new.md) — construction
- [objects.md](./objects.md) — prototypes & literals
- [properties.md](./properties.md) — descriptors
- [map.md](./map.md) — WeakMap privacy pattern
- [error.md](./error.md) — custom Error subclasses
- [import_export.md](./import_export.md) — exporting classes
