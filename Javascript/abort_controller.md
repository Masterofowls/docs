...
- [fetch.md](./fetch.md) — fetch + signal
- [timers.md](./timers.md) — timeout patterns
- [promise.md](./promise.md) — rejection handling
- [DOM/events.md](./DOM/events.md) — signal option
- [event_loop.md](./event_loop.md) — async cancellation
