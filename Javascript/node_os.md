...
- [Path](path.md) — join home/tmp with filenames
- [process](process.md) — env, cwd, platform via process
- [fs](fs.md) — create dirs under homedir/tmpdir
- [child_process](child_process.md) — OS-specific binaries
