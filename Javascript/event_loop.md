...
- [promise.md](./promise.md) — microtask reactions
- [async.md](./async.md) — async/await desugaring
- [timers.md](./timers.md) — macrotask timers
- [web_workers.md](./web_workers.md) — off-main-thread
- [DOM/events.md](./DOM/events.md) — event tasks
