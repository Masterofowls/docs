...
- [number.md](./number.md) — numeric falsy values
- [strings.md](./strings.md) — empty strings
- [objects.md](./objects.md) — nullish patterns
- [switch_case.md](./switch_case.md) — branching
- [error.md](./error.md) — assertions
