...
- [number.md](./number.md) — timestamps as numbers
- [json.md](./json.md) — Date serialization
- [api.md](./api.md) — Intl and runtime helpers
- [strings.md](./strings.md) — ISO string handling
- [math.md](./math.md) — rounding durations
