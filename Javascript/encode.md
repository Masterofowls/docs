...
- [url.md](./url.md) — URL and search params
- [fetch.md](./fetch.md) — request bodies
- [strings.md](./strings.md) — string ops
- [api.md](./api.md) — TextEncoder / crypto
- [json.md](./json.md) — JSON payloads
