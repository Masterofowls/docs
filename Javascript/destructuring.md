...
- [spread_rest.md](./spread_rest.md) — rest/spread siblings
- [objects.md](./objects.md) — object shapes
- [arrays.md](./arrays.md) — array unpacking
- [functions.md](./functions.md) — param destructuring
- [optional_chaining.md](./optional_chaining.md) — safe deep access
