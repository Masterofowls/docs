...
- [boolean.md](./boolean.md) — conditions
- [objects.md](./objects.md) — dispatch tables
- [map.md](./map.md) — Map-based dispatch
- [error.md](./error.md) — default throws
- [oop.md](./oop.md) — polymorphic alternatives
