...
- [oop.md](./oop.md) — classes & inheritance
- [objects.md](./objects.md) — prototypes
- [properties.md](./properties.md) — defining instance props
- [error.md](./error.md) — `new Error`
- [map.md](./map.md) — `new Map`
- [date.md](./date.md) — `new Date`
