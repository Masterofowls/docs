...
- [strings.md](./strings.md) — string methods
- [f-string style](./strings.md) — formatting
- [optional_chaining.md](./optional_chaining.md) — in interpolations
- [regex.md](./regex.md) — patterns vs templates
- [encode.md](./encode.md) — escaping
