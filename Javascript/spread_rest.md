...
- [destructuring.md](./destructuring.md) — rest patterns
- [arrays.md](./arrays.md) — array copy/concat
- [objects.md](./objects.md) — object assign/merge
- [functions.md](./functions.md) — rest params
