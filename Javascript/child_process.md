...
- [process](process.md) — env, cwd, exit codes
- [Stream](stream.md) — child stdio streams
- [Events](events_node.md) — `close` / `error` events
- [util](util.md) — `promisify(execFile)`
- [Path](path.md) — resolve executable paths
