...
- [window.md](./window.md) — viewport metrics
- [position.md](./position.md) — element geometry
- [events.md](./events.md) — resize / orientation
- [navigation.md](./navigation.md) — fullscreen flows
- [../math.md](../math.md) — rounding DPR sizes
- [../api.md](../api.md) — media / display APIs
