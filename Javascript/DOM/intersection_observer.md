...
- [mutation_observer.md](./mutation_observer.md) — DOM change watching
- [resize_observer.md](./resize_observer.md) — size changes
- [events.md](./events.md) — scroll events alternative
- [position.md](./position.md) — geometry
- [../timers.md](../timers.md) — rAF pairing
