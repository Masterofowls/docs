...
- [content_methods.md](./content_methods.md) — content updates
- [events.md](./events.md) — user-driven changes
- [attributes.md](./attributes.md) — attribute mutations
- [selectors.md](./selectors.md) — finding roots
- [../async.md](../async.md) — microtask timing
