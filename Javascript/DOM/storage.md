...
- [window.md](./window.md) — window.localStorage
- [events.md](./events.md) — storage event
- [../json.md](../json.md) — serialize values
- [../error.md](../error.md) — quota errors
- [navigation.md](./navigation.md) — session lifecycle
- [../objects.md](../objects.md) — plain data shapes
