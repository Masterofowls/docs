...
- [date.md](./date.md) — Date object
- [number.md](./number.md) — numeric values
- [strings.md](./strings.md) — string compare
- [template_literals.md](./template_literals.md) — building messages
- [performance.md](./performance.md) — reuse formatters
