...
- [objects.md](./objects.md) — plain objects
- [arrays.md](./arrays.md) — JSON arrays
- [fetch.md](./fetch.md) — JSON HTTP bodies
- [date.md](./date.md) — Date ↔ ISO
- [map.md](./map.md) — serializing Maps
- [error.md](./error.md) — SyntaxError on parse
- [strings.md](./strings.md) — text handling
