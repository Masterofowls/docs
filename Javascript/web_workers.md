...
- [structured_clone.md](./structured_clone.md) — clone/transfer
- [typed_arrays.md](./typed_arrays.md) — binary payloads
- [event_loop.md](./event_loop.md) — main thread vs worker
- [abort_controller.md](./abort_controller.md) — cancel work
- [performance.md](./performance.md) — measuring offload wins
