...
- [destructuring.md](./destructuring.md) — defaults on unpack
- [error.md](./error.md) — TypeError without `?.`
- [objects.md](./objects.md) — property access
- [DOM/selectors.md](./DOM/selectors.md) — nullable query results
