...
- [effects.md](./effects) — shadows and visuals
- [transitions.md](./transitions) — animating filters
- [background.md](./background) — translucent backgrounds
- [z_index.md](./z_index) — stacking contexts
- [performance via blur](./effects) — cost awareness
