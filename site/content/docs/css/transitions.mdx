...
- [animation.md](./animation) — keyframes
- [transform.md](./transform) — transform props
- [effects.md](./effects) — shadows/filters
- [hover.md](./hover) — hover triggers
- [dark_mode.md](./dark_mode) — theme transitions
