...
- [variables.md](./variables) — color tokens
- [gradient.md](./gradient) — gradients
- [dark_mode.md](./dark_mode) — theme palettes
- [background.md](./background) — backgrounds
- [filter_backdrop.md](./filter_backdrop) — filter color effects
