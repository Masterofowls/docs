...
- [Input](input) — control types and attributes
- [Label / lists](list) — structuring options (see also fieldset patterns here)
- [Script](script) — progressive enhancement of submit handlers
- [URL](url) — `action` URLs and query strings
- [Meta](meta) — CSRF tokens sometimes injected via meta + JS
- [Nav](nav) — do not confuse search forms with navigation landmarks
- [Footer](footer) — newsletter forms in footers
