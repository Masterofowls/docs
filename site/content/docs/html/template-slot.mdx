...
- [web_components.md](/docs/html/web-components) — full stack
- [../Javascript/DOM/shadow_dom.md](/docs/html/../javascript/dom/shadow-dom) — shadow trees
- [../Javascript/DOM/custom_elements.md](/docs/html/../javascript/dom/custom-elements) — custom elements
