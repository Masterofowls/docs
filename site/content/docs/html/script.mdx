...
- [Head](head) — where to place scripts
- [Src](src) — resolving script URLs
- [URL](url) — CDN and absolute paths
- [Meta](meta) — CSP meta vs headers
- [Form](form) — progressive enhancement of forms
- [Canvas](canvas) — scripts that draw
- [Style](style) — FOUC and load ordering with CSS
