...
- [Src](src) — `src`, `srcset`, and URL resolution
- [URL](url) — absolute vs relative media URLs
- [Canvas](canvas) — drawing frames from video/images
- [Figure patterns](section) — grouping media with captions
- [Script](script) — custom players and Media element API
- [Style](style) — object-fit and responsive CSS
