...
- [Nav](nav) — menus built from lists
- [Input](input) — `list` + `<datalist>`
- [Section](section) — grouping list-heavy content
- [Table](table) — when tabular data beats lists
- [Div](div) — avoid replacing lists with divs
- [Form](form) — option groups vs lists
