...
- [List](list) — alternative for non-tabular sets
- [Section](section) — wrapping data sections
- [Div](div) — scroll wrappers
- [Form](form) — inputs inside table cells
- [Input](input) — editable grids
- [Canvas](canvas) — charts vs data tables (provide both)
- [Style](style) — table layout CSS
