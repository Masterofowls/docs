...
- [List](list) — `ul`/`ol` patterns for menus
- [Footer](footer) — secondary nav in footers
- [Section](section) — TOC within articles
- [Div](div) — layout wrappers around nav
- [Language](language) — language switchers
- [URL](url) — link targets and fragments
