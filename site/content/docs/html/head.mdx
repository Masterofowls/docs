...
- [Meta](meta) — meta element details
- [Script](script) — loading JS from head or body
- [Style](style) — `<style>` and linked CSS
- [URL](url) — canonical and alternate URLs
- [Language](language) — `lang` on `<html>`, hreflang
- [XML](xml) — XHTML / polyglot considerations
