...
- [Head](head) — where meta belongs
- [URL](url) — canonical URLs alongside meta
- [Language](language) — prefer `lang` over `content-language`
- [Media](media) — OG image assets
- [Script](script) — CSP interaction with inline scripts
- [XML](xml) — metadata in XML documents
