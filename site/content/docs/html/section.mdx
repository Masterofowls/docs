...
- [Div](div) — non-semantic containers
- [Nav](nav) — navigation sections
- [Footer](footer) — section and page footers
- [Form](form) — forms inside sections
- [List](list) — TOC lists for long sections
- [Language](language) — `lang` on a section
- [Style](style) — styling section layouts
