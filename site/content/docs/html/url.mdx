...
- [Src](src) — resource URL attributes
- [Head](head) — canonical and base
- [Form](form) — `action` and method
- [Media](media) — media resource URLs
- [Nav](nav) — in-site link patterns
- [Language](language) — locale in paths / hreflang
- [Meta](meta) — OG URLs
- [XML](xml) — XML Base / namespaces
