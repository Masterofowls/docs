...
- [Head](head) — linking stylesheets
- [Div](div) — layout hooks for CSS
- [Script](script) — load order with JS
- [Meta](meta) — `color-scheme`, theme-color
- [Media](media) — styling images/video (`object-fit`)
- [Canvas](canvas) — CSS size vs bitmap size
- [Section](section) — styling landmarks
