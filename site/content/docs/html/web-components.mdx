...
- [template_slot.md](/docs/html/template-slot) — template & slot
- [../Javascript/DOM/custom_elements.md](/docs/html/../javascript/dom/custom-elements) — element API
- [../Javascript/DOM/shadow_dom.md](/docs/html/../javascript/dom/shadow-dom) — shadow API
