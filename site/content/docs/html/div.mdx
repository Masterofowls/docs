...
- [Section](section) — thematic grouping with headings
- [Nav](nav) — navigation landmark
- [Footer](footer) — footer / contentinfo
- [Form](form) — form layout containers
- [Style](style) — styling hooks
- [Canvas](canvas) — wrapping drawing surfaces
- [Language](language) — `lang` on containers
