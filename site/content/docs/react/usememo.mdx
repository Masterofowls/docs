...
- [useCallback.md](./useCallback) — function identity
- [memo.md](./memo) — skip child re-renders
- [performance.md](./performance) — when to optimize
- [useContext.md](./useContext) — stable provider values
- [hooks.md](./hooks) — rules
