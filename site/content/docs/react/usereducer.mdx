...
- [useState.md](./useState) — simpler state
- [hooks.md](./hooks) — rules
- [context.md](./context) — dispatch via context
- [testing.md](./testing) — pure reducer tests
- [performance.md](./performance) — update patterns
