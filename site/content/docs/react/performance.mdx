...
- [memo.md](./memo) — skip renders
- [useMemo.md](./useMemo) / [useCallback.md](./useCallback)
- [useTransition.md](./useTransition) — responsiveness
- [suspense.md](./suspense) — code split
- [keys_lists.md](./keys_lists) — list identity
