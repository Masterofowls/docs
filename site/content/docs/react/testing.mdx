...
- [hooks.md](./hooks) — test via components
- [custom_hooks.md](./custom_hooks) — `renderHook`
- [router.md](./router) — MemoryRouter
- [forms.md](./forms) — form interactions
- [error_boundaries.md](./error_boundaries) — error UI
