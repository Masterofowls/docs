...
- [context.md](./context) — Provider patterns
- [hooks.md](./hooks) — rules of hooks
- [useMemo.md](./useMemo) — stabilize values
- [performance.md](./performance) — re-render control
- [custom_hooks.md](./custom_hooks) — `useTheme()` wrappers
