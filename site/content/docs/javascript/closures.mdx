...
- [this_keyword.md](/docs/javascript/this-keyword) — `this` vs lexical capture
- [modules_commonjs.md](/docs/javascript/modules-commonjs) — module scope
- [oop.md](/docs/javascript/oop) — private fields alternative
- [event_loop.md](/docs/javascript/event-loop) — async + closures
