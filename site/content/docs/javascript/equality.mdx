...
- [type_coercion.md](./type_coercion) — how `==` coerces
- [boolean.md](./boolean) — truthiness
- [nullish_coalescing.md](./nullish_coalescing) — nullish ops
- [object / map](./map) — SameValueZero keys
- [number.md](./number) — NaN and floats
