...
- [structured_clone.md](./structured_clone) — clone/transfer
- [typed_arrays.md](./typed_arrays) — binary payloads
- [event_loop.md](./event_loop) — main thread vs worker
- [abort_controller.md](./abort_controller) — cancel work
- [performance.md](./performance) — measuring offload wins
