...
- [number.md](./number) — numeric falsy values
- [strings.md](./strings) — empty strings
- [objects.md](./objects) — nullish patterns
- [switch_case.md](./switch_case) — branching
- [error.md](./error) — assertions
