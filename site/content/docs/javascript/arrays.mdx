...
- [iteration.md](./iteration) — looping patterns
- [for_of.md](./for_of) — for...of
- [iterator.md](./iterator) — iterable protocol
- [map.md](./map) — Map collections
- [set.md](./set) — unique values
- [objects.md](./objects) — Object.groupBy
- [json.md](./json) — serialize arrays
