...
- [set.md](./set) — Set collections
- [objects.md](./objects) — plain object maps
- [iteration.md](./iteration) — iterating Maps
- [for_of.md](./for_of) — for...of entries
- [json.md](./json) — serialization
- [arrays.md](./arrays) — Object.groupBy
