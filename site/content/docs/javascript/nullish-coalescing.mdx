...
- [optional_chaining.md](./optional_chaining) — `?.` + `??`
- [equality.md](./equality) — null vs undefined
- [destructuring.md](./destructuring) — default values
- [ternary.md](./ternary) — explicit conditionals
