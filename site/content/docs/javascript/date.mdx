...
- [number.md](./number) — timestamps as numbers
- [json.md](./json) — Date serialization
- [api.md](./api) — Intl and runtime helpers
- [strings.md](./strings) — ISO string handling
- [math.md](./math) — rounding durations
