...
- [conditionals.md](./conditionals) — if/else
- [nullish_coalescing.md](./nullish_coalescing) — `??`
- [boolean.md](./boolean) — truthiness
- [optional_chaining.md](./optional_chaining) — safe access
- [equality.md](./equality) — comparisons in conditions
