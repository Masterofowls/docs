...
- [objects.md](./objects) — property descriptors
- [strict_mode.md](./strict_mode) — TypeError on mutate
- [structured_clone.md](./structured_clone) — deep copy
- [proxy_reflect.md](./proxy_reflect) — deeper control
- [spread_rest.md](./spread_rest) — immutable updates
