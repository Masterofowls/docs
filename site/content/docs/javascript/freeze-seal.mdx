...
- [strict_mode.md](/docs/javascript/strict-mode) — TypeError on mutate
- [structured_clone.md](/docs/javascript/structured-clone) — deep copy
- [proxy_reflect.md](/docs/javascript/proxy-reflect) — deeper control
- [spread_rest.md](/docs/javascript/spread-rest) — immutable updates
