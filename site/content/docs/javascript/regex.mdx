...
- [strings.md](./strings) — string APIs
- [template_literals.md](./template_literals) — building patterns
- [encode.md](./encode) — encoding vs matching
- [error.md](./error) — SyntaxError on bad patterns
