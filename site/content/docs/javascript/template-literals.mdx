...
- [strings.md](./strings) — string methods
- [f-string style](./strings) — formatting
- [optional_chaining.md](./optional_chaining) — in interpolations
- [regex.md](./regex) — patterns vs templates
- [encode.md](./encode) — escaping
