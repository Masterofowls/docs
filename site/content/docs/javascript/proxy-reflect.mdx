...
- [objects.md](./objects) — property model
- [prototypes.md](./prototypes) — prototype ops
- [symbol.md](./symbol) — well-known symbols
- [freeze_seal.md](./freeze_seal) — hardening without Proxy
- [oop.md](./oop) — classes vs interception
