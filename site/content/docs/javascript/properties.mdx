...
- [objects.md](./objects) — object basics
- [oop.md](./oop) — class getters/fields
- [new.md](./new) — instance creation
- [map.md](./map) — alternative key storage
- [json.md](./json) — enumerable own props only
