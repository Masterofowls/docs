...
- [timers.md](./timers) — rAF / scheduling
- [event_loop.md](./event_loop) — long tasks
- [web_workers.md](./web_workers) — offload CPU
- [fetch.md](./fetch) — network cost
- [DOM/events.md](./DOM/events) — event timing
