...
- [json.md](./json) — JSON clone limits
- [web_workers.md](./web_workers) — postMessage
- [typed_arrays.md](./typed_arrays) — transferable buffers
- [history_api.md](./history_api) — pushState data
- [freeze_seal.md](./freeze_seal) — immutability after clone
