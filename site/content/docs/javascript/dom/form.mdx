...
- [events.md](./events) — submit/input
- [attributes.md](./attributes) — required / name
- [selectors.md](./selectors) — finding controls
- [../fetch.md](../fetch) — posting FormData
- [../json.md](../json) — JSON bodies
- [../encode.md](../encode) — URLSearchParams
- [datatransfer.md](./datatransfer) — file drops
