...
- [document_methods.md](./document_methods) — document
- [navigation.md](./navigation) — location / history
- [screen.md](./screen) — screen metrics
- [position.md](./position) — scroll & geometry
- [events.md](./events) — window events
- [storage.md](./storage) — localStorage
- [../api.md](../api) — timers & fetch globals
- [../fetch.md](../fetch) — networking
