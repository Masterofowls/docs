...
- [shadow_dom.md](./shadow_dom) — encapsulation
- [../Html/template_slot.md](../../Html/template_slot) — templates
- [../Html/web_components.md](../../Html/web_components) — overview
- [attributes.md](./attributes) — attribute APIs
- [events.md](./events) — CustomEvent
