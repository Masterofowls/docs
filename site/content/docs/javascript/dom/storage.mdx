...
- [window.md](./window) — window.localStorage
- [events.md](./events) — storage event
- [../json.md](../json) — serialize values
- [../error.md](../error) — quota errors
- [navigation.md](./navigation) — session lifecycle
- [../objects.md](../objects) — plain data shapes
