...
- [window.md](./window) — viewport metrics
- [position.md](./position) — element geometry
- [events.md](./events) — resize / orientation
- [navigation.md](./navigation) — fullscreen flows
- [../math.md](../math) — rounding DPR sizes
- [../api.md](../api) — media / display APIs
