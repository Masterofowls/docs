...
- [mutation_observer.md](./mutation_observer) — DOM change watching
- [resize_observer.md](./resize_observer) — size changes
- [events.md](./events) — scroll events alternative
- [position.md](./position) — geometry
- [../timers.md](../timers) — rAF pairing
