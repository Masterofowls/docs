---
title: "Navigation (Location & History)"
...
- [window.md](./window) — window object
- [../url.md](../url) — URL / search params
- [../encode.md](../encode) — encoding paths
- [events.md](./events) — popstate / hashchange
- [document_methods.md](./document_methods) — document.URL
- [storage.md](./storage) — persisting UI state
