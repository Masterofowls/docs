...
- [custom_elements.md](/docs/javascript/dom/custom-elements) — defining elements
- [../Html/template_slot.md](/docs/javascript/../html/template-slot) — slot HTML
- [../Html/web_components.md](/docs/javascript/../html/web-components) — stack overview
