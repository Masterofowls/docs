...
- [../Html/canvas.md](../../Html/canvas) — canvas element
- [../typed_arrays.md](../typed_arrays) — ImageData buffers
- [../timers.md](../timers) — rAF loops
- [resize_observer.md](./resize_observer) — responsive canvas
- [../performance.md](../performance) — draw cost
