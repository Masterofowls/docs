...
- [form.md](./form) — submit / input events
- [datatransfer.md](./datatransfer) — drag events
- [selectors.md](./selectors) — closest / matches
- [window.md](./window) — window-level events
- [mutation_methods.md](./mutation_methods) — MutationObserver
- [../api.md](../api) — AbortSignal
- [../async.md](../async) — async handlers
