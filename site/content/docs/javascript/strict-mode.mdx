...
- [this_keyword.md](./this_keyword) — undefined this
- [import_export.md](./import_export) — modules are strict
- [error.md](./error) — thrown errors
- [freeze_seal.md](./freeze_seal) — TypeError on mutate
- [equality.md](./equality) — cleaner semantics
