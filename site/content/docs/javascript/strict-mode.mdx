...
- [this_keyword.md](/docs/javascript/this-keyword) — undefined this
- [import_export.md](/docs/javascript/import-export) — modules are strict
- [error.md](/docs/javascript/error) — thrown errors
- [freeze_seal.md](/docs/javascript/freeze-seal) — TypeError on mutate
