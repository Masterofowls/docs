...
- [number.md](./number) — Number methods & parsing
- [date.md](./date) — time arithmetic
- [api.md](./api) — crypto random
- [arrays.md](./arrays) — reduce aggregates
- [boolean.md](./boolean) — comparisons
