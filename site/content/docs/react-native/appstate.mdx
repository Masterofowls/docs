...
- [biometrics.md](./biometrics) — unlock
- [player.md](./player) — pause media
- [notification.md](./notification) — background
- [storage.md](./storage) — persist on blur
- [navigation.md](./navigation) — blur events
