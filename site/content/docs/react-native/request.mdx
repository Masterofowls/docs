...
- [networking.md](./networking) — transport basics
- [storage.md](./storage) — token persistence
- [settings.md](./settings) — env / config flags
- [deeplinking.md](./deeplinking) — post-auth routes
