...
- [platform_specific.md](./platform_specific) — iOS vs Android UI
- [basic_primitives.md](./basic_primitives) — form layout
- [touchable.md](./touchable) — open custom pickers
- [modal.md](./modal) — picker in modal
