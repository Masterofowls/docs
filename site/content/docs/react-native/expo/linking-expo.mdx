...
- [router.md](./router) — Expo Router
- [config.md](./config) — scheme
- [../linking.md](../linking) — RN Linking
- [../deeplinking.md](../deeplinking) — deep links
- [../navigation.md](../navigation) — navigation linking
