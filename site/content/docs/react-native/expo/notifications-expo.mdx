...
- [config.md](./config) — plugin / projectId
- [../notification.md](../notification) — general notes
- [../permissions.md](../permissions) — permission UX
- [linking_expo.md](./linking_expo) — open from tap
- [constants.md](./constants) — project config
