...
Unpacking assigns elements of iterables (and keys/values of mappings with `**`) into names or containers. Covers tuple unpacking, starred targets, function call unpacking, and dict merges. Related to but broader than [*args/**kwargs](kwags).
