  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-10 px-6 py-16">
      <header className="space-y-4">
        <p className="text-sm font-medium text-fd-muted-foreground tracking-wide uppercase">
          Personal cheat-sheet library
        </p>
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Code Reference</h1>
        <p className="max-w-2xl text-lg text-fd-muted-foreground">
          Focused notes for web and app development — overview, syntax, examples, and
          pitfalls. Built with{' '}
          <a
