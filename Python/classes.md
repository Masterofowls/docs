...
Classes define object types: attributes + methods. Prefer clear `__init__`, type hints, and small cohesive classes. For data-heavy records, consider [dataclasses](dataclasses.md) first.
