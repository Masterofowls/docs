...
- [Nav](nav.md) — menus built from lists
- [Input](input.md) — `list` + `<datalist>`
- [Section](section.md) — grouping list-heavy content
- [Table](table.md) — when tabular data beats lists
- [Div](div.md) — avoid replacing lists with divs
- [Form](form.md) — option groups vs lists
