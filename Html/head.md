...
- [Meta](meta.md) — meta element details
- [Script](script.md) — loading JS from head or body
- [Style](style.md) — `<style>` and linked CSS
- [URL](url.md) — canonical and alternate URLs
- [Language](language.md) — `lang` on `<html>`, hreflang
- [XML](xml.md) — XHTML / polyglot considerations
