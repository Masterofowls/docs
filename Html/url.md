...
- [Src](src.md) — resource URL attributes
- [Head](head.md) — canonical and base
- [Form](form.md) — `action` and method
- [Media](media.md) — media resource URLs
- [Nav](nav.md) — in-site link patterns
- [Language](language.md) — locale in paths / hreflang
- [Meta](meta.md) — OG URLs
- [XML](xml.md) — XML Base / namespaces
