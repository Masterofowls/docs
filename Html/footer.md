...
- [Nav](nav.md) — footer link groups
- [Section](section.md) — sectioning ancestors
- [Div](div.md) — non-semantic layout
- [Form](form.md) — newsletter signup patterns
- [Meta](meta.md) — document-level metadata (not a substitute for visible footer)
- [Language](language.md) — `lang` on footer snippets
