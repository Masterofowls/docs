...
- [Head](head.md) — where meta belongs
- [URL](url.md) — canonical URLs alongside meta
- [Language](language.md) — prefer `lang` over `content-language`
- [Media](media.md) — OG image assets
- [Script](script.md) — CSP interaction with inline scripts
- [XML](xml.md) — metadata in XML documents
