...
- [Head](head.md) — document setup and alternate links
- [Meta](meta.md) — content-language meta (legacy; prefer `lang`)
- [XML](xml.md) — `xml:lang` in XML/XHTML
- [Nav](nav.md) — language switchers
- [Section](section.md) — scoping translated regions
- [URL](url.md) — locale prefixes in paths
