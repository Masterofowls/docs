...
- [biometrics.md](./biometrics.md) — unlock
- [player.md](./player.md) — pause media
- [notification.md](./notification.md) — background
- [storage.md](./storage.md) — persist on blur
- [navigation.md](./navigation.md) — blur events
