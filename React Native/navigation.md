...
- [touchable.md](./touchable.md) — Pressable
- [deeplinking.md](./deeplinking.md) — URL schemes
- [drawer.md](./drawer.md) — drawer patterns
- [backhandler.md](./backhandler.md) — Android back
- [Expo router](./Expo/router.md) — file-based routing
