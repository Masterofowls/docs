...
- [plugins.md](./plugins.md) — config plugins
- [build.md](./build.md) — applying config in builds
- [filestructure.md](./filestructure.md) — where config lives
- [commands.md](./commands.md) — `expo config`
