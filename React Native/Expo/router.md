...
- [config.md](./config.md) — scheme / plugins
- [linking_expo.md](./linking_expo.md) — deep links
- [filestructure.md](./filestructure.md) — app dir
- [../navigation.md](../navigation.md) — React Navigation concepts
- [../deeplinking.md](../deeplinking.md) — native linking
